  ...
  return (
    <div className="lg:flex md:flex items-center justify-center">
      <div>
        ...
        <p className="mt-4 text-center lg:text-left text-base opacity-80 md:text-left">
        ...
        <img
          ...
          />
          <div className="border bg-blue-100 border-blue-200 hidden lg:block py-3 px-5 w-fit rounded-t-3xl rounded-br-3xl relative bottom-[420px] left-[300px]"> 
